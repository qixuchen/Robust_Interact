...
facetT *my_qh_makenew_nonsimplicial(facetT *visible, vertexT *apex, int *numnew);
facetT *qh_makenew_simplicial(facetT *visible, vertexT *apex, int *numnew);
facetT *my_qh_makenew_simplicial(facetT *visible, vertexT *apex, int *numnew);
...
void    myqh_initialhull(setT *vertices);
setT   *qh_initialvertices(int dim, setT *maxpoints, pointT *points, int numpoints);
vertexT *qh_isvertex(pointT *point, setT *vertices);
vertexT *qh_makenewfacets(pointT *point /*horizon_list, visible_list*/);
vertexT *my_qh_makenewfacets(pointT *point /*horizon_list, visible_list*/);
